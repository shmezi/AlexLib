...
import me.alexirving.lib.utils.Colors
import me.alexirving.lib.utils.color
import me.alexirving.lib.database.model.Cacheable
import me.alexirving.lib.database.model.Database
import me.alexirving.lib.task.SimpleScheduler
...
open class CachedDbManager<ID, T : Cacheable<ID>>(
    ...
    init {
        ...
        if (autoUpdate > 0)
            SimpleScheduler().buildTask { update() }.repeat(Duration.ofSeconds(autoUpdate))
